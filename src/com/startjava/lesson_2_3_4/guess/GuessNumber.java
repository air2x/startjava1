...
public class GuessNumber {
    ...
    public void start() {
        ...
        while (true) {
            if (!checkPlayerNum(secretNum, player1)) {
                break;
            }

            if (!checkPlayerNum(secretNum, player2) || player2.getNumAttempt() == 10) {
                break;
            }
        }
    ...
    private static boolean checkPlayerNum(int secretNum, Player player) {
